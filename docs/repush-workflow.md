...
4. Run **`/ado-testforge/qa-publish`** with Plan ID and User Story ID.
5. When asked to confirm, type **YES** and ensure the AI uses **`repush: true`** when calling `qa_publish_push`.
