...
- **Persona:** `<div><strong>Persona:</strong> </div><ul><li>Label<ul><li>TPM Roles = x</li><li>Profile = y</li><li>PSG = z</li></ul></li></ul>`
...
- **Persona** section: each persona has nested sub-bullets for TPM Roles, Profile, PSG
