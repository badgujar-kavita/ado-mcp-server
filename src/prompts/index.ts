    ...
    messages: [{
      ...
      content: {
        ...
        text: [
          ...
          "4. Functionality Process Flow — BE SMART:",
          "   - Carefully assess if you can create an ACCURATE flow diagram based on the available information.",
          "   - ONLY create a Mermaid diagram if:",
          "     * Object relationships and dependencies are CLEARLY stated in the Solution Design",
          "     * The flow logic (triggers, conditions, decision points) is explicitly documented",
          "     * You are 100% confident the diagram accurately represents the functionality",
          "   - If the above conditions are NOT met, use a TEXT-BASED business functional flow instead:",
          "     * Write a clear, step-by-step narrative of the business process",
          "     * Focus on WHAT happens (business logic) not HOW (technical implementation)",
          "     * Example: '1. User creates Tactic → 2. System checks TPM_Consider_Product_Category_Access__c → 3. If TRUE, system evaluates Product Category access → 4. Sharing records created based on access level'",
          "   - NEVER create Mermaid diagrams with assumed/guessed relationships. Accuracy > Visual appeal.",
