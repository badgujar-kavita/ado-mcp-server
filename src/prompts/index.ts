    ...
    messages: [{
      ...
      content: {
        ...
        text: [
          ...
          "3. If NO draft: Fetch US via get_user_story. Apply BOTH skills: test-case-asset-manager for folder structure (create tc-drafts/US_<ID>/ with test_cases.md, solution_design_summary.md, qa_cheat_sheet.md) and draft-test-cases-salesforce-tpm for content quality (analyze US + Solution Design, coverage matrix, process flow, Test Coverage Insights). Derive business-specific terms from source material. Call save_tc_draft for main file and create supporting documents. ALWAYS pass workspaceRoot or draftsPath. Tell me: 'I've created draft files. Please review at the paths shown. When ready, run this command again and confirm.' Do NOT call push_tc_draft_to_ado.",
